...
case class LoadStoreUnitParams(
    ...
    val numGlobalStqEntries: Int = 8, // limited to 4 decoded global store insts per warp
    val numSharedLdqEntries: Int = 16, // limited to 8 decoded shared load insts per warp
    val numSharedStqEntries: Int = 8, // limited to 8 decoded shared store insts per warp
