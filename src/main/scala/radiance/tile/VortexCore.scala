...
class Vortex(tile: RadianceTile)(implicit p: Parameters)
  ...
  addResource("/vsrc/vortex/hw/rtl/core/VX_alu_int.sv")
  addResource("/vsrc/vortex/hw/rtl/core/VX_alu_unit.sv")
  addResource("/vsrc/vortex/hw/rtl/core/VX_alu_muldiv.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/core/VX_issue_slice.sv")
  addResource("/vsrc/vortex/hw/rtl/core/VX_lsu_slice.sv")
  addResource("/vsrc/vortex/hw/rtl/core/VX_lsu_unit.sv")
  addResource("/vsrc/vortex/hw/rtl/core/VX_mem_unit.sv")
  addResource("/vsrc/vortex/hw/rtl/core/VX_operands.sv")
  addResource("/vsrc/vortex/hw/rtl/core/VX_pe_switch.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/core/VX_uuid_gen.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/mem/VX_lmem_switch.sv")
  addResource("/vsrc/vortex/hw/rtl/mem/VX_local_mem.sv")
  addResource("/vsrc/vortex/hw/rtl/mem/VX_lsu_adapter.sv")
  addResource("/vsrc/vortex/hw/rtl/mem/VX_lsu_mem_arb.sv")
  addResource("/vsrc/vortex/hw/rtl/mem/VX_lsu_mem_if.sv")
  addResource("/vsrc/vortex/hw/rtl/mem/VX_mem_arb.sv")
  addResource("/vsrc/vortex/hw/rtl/mem/VX_mem_bus_if.sv")
  addResource("/vsrc/vortex/hw/rtl/mem/VX_mem_switch.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/libs/VX_async_ram_patch.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_avs_adapter.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_axi_adapter.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_axi_write_ack.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_bits_concat.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/libs/VX_demux.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_divider.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_dp_ram.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_edge_trigger.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/libs/VX_mem_bank_adapter.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_mem_coalescer.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_mem_data_adapter.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/libs/VX_onehot_shift.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_pe_serializer.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/libs/VX_placeholder.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/libs/VX_reduce_tree.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/libs/VX_stream_omega.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_stream_pack.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_stream_switch.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_stream_unpack.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_stream_xbar.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_toggle_buffer.sv")
  addResource("/vsrc/vortex/hw/rtl/libs/VX_transpose.sv")
  ...
  // fpu
  // start comment out for synthesis ------------------------
  addResource("/vsrc/vortex/hw/rtl/fpu/VX_fpu_csr_if.sv")
  addResource("/vsrc/vortex/hw/rtl/fpu/VX_fpu_define.vh")
  addResource("/vsrc/vortex/hw/rtl/fpu/VX_fp_classifier.sv")
  addResource("/vsrc/vortex/hw/rtl/fpu/VX_fp_rounding.sv")
  addResource("/vsrc/vortex/hw/rtl/fpu/VX_fpu_cvt.sv")
  addResource("/vsrc/vortex/hw/rtl/fpu/VX_fpu_ncp.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/fpu/VX_fncp_unit.sv")
  addResource("/vsrc/vortex/hw/rtl/fpu/VX_fpu_fpnew.sv")
  addResource("/vsrc/vortex/hw/rtl/fpu/VX_fcvt_unit.sv")
  ...
  // to radiance.mk
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_cast_multi.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_classifier.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_divsqrt_multi.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_divsqrt_th_32.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_divsqrt_th_64_multi.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_fma_multi.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_fma.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_noncomp.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_opgroup_block.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_opgroup_fmt_slice.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_opgroup_multifmt_slice.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_rounding.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpnew_top.sv")

  addResource("/vsrc/vortex/third_party/cvfpu/src/fpu_div_sqrt_mvp/hdl/control_mvp.sv")
  // in radiance.mk
  // addResource("/vsrc/vortex/third_party/cvfpu/src/fpu_div_sqrt_mvp/hdl/defs_div_sqrt_mvp.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpu_div_sqrt_mvp/hdl/div_sqrt_mvp_wrapper.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpu_div_sqrt_mvp/hdl/div_sqrt_top_mvp.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpu_div_sqrt_mvp/hdl/iteration_div_sqrt_mvp.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpu_div_sqrt_mvp/hdl/norm_div_sqrt_mvp.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpu_div_sqrt_mvp/hdl/nrbd_nrsc_mvp.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/fpu_div_sqrt_mvp/hdl/preprocess_mvp.sv")

  // only include actually referenced modules in fpnew/common_cells; otherwise
  // results in elaboration error
  addResource("/vsrc/vortex/third_party/cvfpu/src/common_cells/include/common_cells/registers.svh")
  addResource("/vsrc/vortex/third_party/cvfpu/src/common_cells/src/cf_math_pkg.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/common_cells/src/cb_filter_pkg.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/common_cells/src/ecc_pkg.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/common_cells/src/gray_to_binary.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/common_cells/src/lzc.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/common_cells/src/rr_arb_tree.sv")
  addResource("/vsrc/vortex/third_party/cvfpu/src/common_cells/src/spill_register.sv")
  ...
  addResource("/vsrc/vortex/hw/rtl/interfaces/VX_scoreboard_if.sv")
